...
public class connection {
    ...
    public void push(String id,String tid,String e_id,String description) throws IOException {
        RequestTask requestTask = new RequestTask(id,tid,e_id,description);
        requestTask.execute("");
    }


    class RequestTask extends AsyncTask<String, String, String> {
        String id,tid,e_id,description;


        public RequestTask(String id,String tid,String e_id,String description){
            this.id=id;
            this.tid=tid;
            this.e_id=e_id;
